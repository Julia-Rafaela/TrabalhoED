...
public class Tela extends JFrame {
	...
	public Tela() {
		...
		ConsultaCorntoller Consult= new ConsultaCorntoller(textFieldNOMEGP, TextAreaNomeAlunosGP, textFieldAREA, textFieldSUBAREA, textFieldDATA, textFieldCodgpCp, textFieldTEMAGP, textAreaRAGP, textAreaCG);
